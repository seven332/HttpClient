...
public class StringGetter implements HttpImpl {
    ...
    @Override
    public void onAfterConnect(HttpURLConnection conn) throws Exception {
    }

    @Override
    public void fillCookie(URL url, Cookie cookie) {
